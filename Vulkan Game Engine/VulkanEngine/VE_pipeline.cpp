...
namespace VE {
	VEPipeline::VEPipeline(VEDevice& device, const std::string& vertPath, const std::string& fragPath, const PipelineConfigInfo& configInfo) : veDevice{ device } {
	...
	std::vector<char> VEPipeline::readFile(const std::string& fpath) {
	...
	void VEPipeline::createPipeline(const std::string& vertPath, const std::string& fragPath, const PipelineConfigInfo& configInfo) {
